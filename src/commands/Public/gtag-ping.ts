...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("ping-gtag")
    .setDescription("Pings 'Looking to Play - GTAG`")
    .setDefaultMemberPermissions(0)
    .addStringOption((option) =>
      option
        .setName("message")
        .setDescription("Your message to ping 'Looking to Play - GTAG'")
        .setRequired(true)
    ),
  ...
  async execute(
    ...
    const channel_to_be_used_in = "1343721013518532650"; // CHANNEL_ID: GTAG ping command channel
    ...
    const roleName = "Looking to Play - GTAG";
