...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("ping-bs")
    .setDescription("Pings 'Looking to Play - BS`")
    .setDefaultMemberPermissions(0)
    .addStringOption((option) =>
      option
        .setName("message")
        .setDescription("Your message to ping 'Looking to Play - BS'")
        .setRequired(true)
    ),
  ...
  async execute(
    ...
    const channel_to_be_used_in = "1343720559405699253"; // CHANNEL_ID: BS ping command channel
    ...
    const roleName = "Looking to Play - BS";
